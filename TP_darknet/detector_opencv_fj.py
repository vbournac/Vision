...
net = dn.load_net("/home/valentin/Documents/Vision/TP_darknet/darknet/cfg/yolov3.cfg", "/home/valentin/Documents/Vision/TP_darknet/darknet/yolov3.weights", 0)
...
r = dn.detectfj(net, meta, "/home/valentin/Documents/Vision/TP_darknet/darknet/data/dog.jpg")
print "test direct path for image :"
print r

## scipy
arr= imread('/home/valentin/Documents/Vision/TP_darknet/darknet/data/dog.jpg')
...
# OpenCV
arr = cv2.imread('/home/valentin/Documents/Vision/TP_darknet/darknet/data/dog.jpg')
im = array_to_image(arr)
dn.rgbgr_image(im)
r = dn.detectfj(net, meta, im)
